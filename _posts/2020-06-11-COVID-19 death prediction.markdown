---
layout: post
title: COVID-19 Predicti Death Count
date: 2020-06-11
description: Error was almost 7 people. It's not that good :(
thumbnail: food2.jpg
...
<h1 id="Data-Description">Data Description<a class="anchor-link" href="#Data-Description">&#182;</a></h1>
</div>
</div>
</div>
<div class="cell border-box-sizing text_cell rendered"><div class="prompt input_prompt">
...
<pre><code>결과코드    resultCode  2   필수  00  결과코드  
...
수정일시분초  UPDATE_DT   30  필수  null    수정일시분초  </code></pre>
...
<pre><code>resultCode  결과코드    2   1   00  결과코드  
